...
class SecurityCameraUI:
    ...
    def draw(
        ...
        self._put_text(canvas, f"Source          {source_label}", (sx + 18, 99), 0.43)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--unknown-seconds", type=float, default=5.0)
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=15.0,
        help="Send a high-priority web alert after this many uninterrupted UNKNOWN-only seconds (default: 15)",
    )
    parser.add_argument(
        "--spoof-seconds",
        type=float,
