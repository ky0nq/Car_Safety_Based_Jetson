"""
Multitask(Eye+Yawn+Pose) ONNX 모델의 Jetson 추론 속도 측정.
입력이 eye_input, face_input 2개짜리라 기존 스크립트와 다름.

사용법:
  python3 benchmark_onnx_jetson_multitask.py --img_size 224 --warmup 20 --runs 200
"""
